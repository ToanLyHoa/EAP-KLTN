...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # When avgpool dont care about input shape
        # output of this layer always (batch, 512, 1, 1, 1)
        # so for any input size, we always have output shape (batch, 101)
        pred = self.avgpool(feature)
